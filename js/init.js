...
(function($) {
	...
	$(function() {
		...
		// Slider.
			...
			var fixed = ['apples_fixed.png', 'book_fixed.png', 'bottles_fixed.png', 'chair_fixed.png', 'crosswalkfixed.png', 'forksfixed.png', 'framefixed.png', 'hiflagsfixed.png', 'm_ms_fixed.png', 'street_fixed.png'];
			var unfixed =['apples.png', 'book.png', 'bottles.png', 'chair.png', 'crosswalkunfixed.png', 'forks.png', 'frameunfixed', 'hiflagsunfixed.png', 'm_ms.png', 'street.png'];
			var counter = 0;

			$('#fix').on('click', function() {
				var bg = $('#banner').css('background-image', "url(imagesfixed/'"+fixed[counter]);
				var bg = $('#banner').css('background-image', "url(imagesunfixed/'"+unfixed[counter]);
				console.log(bg)
				counter++;
			});
